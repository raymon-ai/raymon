...
class Deployment:
    ...
    def __init__(self, model):
        ...
        self.raymon = RaymonAPI(url="http://you.raymon.ai/api",
                                context="Webite Demo",
                                project_id="your_id")

    def process(self, data):
        # Every time you want to trace some data through your system, 
        # Do so by creating a Ray object
        ...
        ray.log(peephole='network_input_img',
                data=rt.ImageGrayscale(data))

        # You can pass it on to other places...
        output = self.subprocessing(data, ray=ray)
        return output
